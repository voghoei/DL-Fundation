...
for epoch in range(opt.max_epochs):
    ...
    torch.save(model.state_dict(), opt.save_path + "model_ver_1.1.0_2class.pt")
    np.save(opt.save_path + "trace_history_ver_1.1.0_2class.npy",[train_loss,train_acc,val_acc])
